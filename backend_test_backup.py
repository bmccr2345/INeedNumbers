...
class DealPackAPITester:
    def __init__(self, base_url="https://realestate-coach-1.preview.emergentagent.com"):
...
if __name__ == "__main__":
    ...
    def test_cors_allowlist_functionality(self):
        ...
        try:
            ...
            # Test allowed origin
            allowed_headers = {
                'Origin': 'https://realestate-coach-1.preview.emergentagent.com',
                'Access-Control-Request-Method': 'GET'
            }
    ...
    def test_stripe_checkout_unauthenticated_starter(self):
        ...
        checkout_data = {
            "plan": "starter",
            "origin_url": "https://realestate-coach-1.preview.emergentagent.com"
        }
