...
const MobileDashboard = () => {
  ...
  return (
    <div className="mobile-dashboard p-4 pb-20 space-y-4 bg-gray-50 min-h-full">
      ...
      {/* AI Coach Banner - PRO users only */}
      {user?.plan === 'PRO' && (
        <AICoachBanner />
      )}

      {/* Financial & Activity Overview - Collapsible */}
      <Card className="bg-white">
        ...
        >
          <div>
            <h3 className="font-semibold text-gray-900">Financial & Activity Overview</h3>
            <p className="text-xs text-gray-600 mt-1">Cap progress & monthly goals</p>
          </div>
        ...
        {showFinancialOverview && (
          <div className="p-4 border-t border-gray-200 space-y-3">
            {/* Cap Progress Summary */}
            <div className="bg-gray-50 p-3 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-gray-700">Commission Cap</span>
                <span className="text-sm font-bold text-primary">{Math.round(dashboardData.capProgress)}%</span>
              </div>
            ...
            <div className="bg-gray-50 p-3 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-gray-700">This Month's Net</span>
            ...
            <div className="bg-gray-50 p-3 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-gray-700">Open Actions</span>
                <span className="text-lg font-bold text-gray-900">
                  {dashboardData.openActions}
                </span>
              </div>
            </div>
            ...
            <Button 
              ...
              onClick={() => setShowFinancialOverview(false)}
            >
              Minimize
            </Button>
          </div>
